...
<ol style="PADDING-LEFT: 30px">
  ...
  <li>Your account will now be transferred from the old instance to the campus Zoom instance
    <ul style="PADDING-LEFT: 20px">
      <li>NOTE: Once your account is transferred your existing browser and Zoom app sessions will be closed and you will need to <a class="external-link" href="https://computing.caes.ucdavis.edu/documentation/helpdesk/sign_in_to_zooom" target="_blank">sign in to Zoom</a> again.</li>
    </ul>
  </li>
</ol>
