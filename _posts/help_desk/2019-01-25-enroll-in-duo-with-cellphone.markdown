---
layout: article
title:  "Enroll in Duo with a regular cell phone"
description: "Use this guide to self-enroll in the Duo MFA (Multi-Factor Authentication) service used on campus with a regular cell phone."
